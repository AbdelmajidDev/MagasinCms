...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
   ...
   /* Unbinder unbinder;
    ...
    TaskManagementActivity activity;
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, TaskManagementActivity activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.activity_add_task, null);
